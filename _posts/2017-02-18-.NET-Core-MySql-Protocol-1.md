...
*大部分人可以直接跳过此章节*，但在实现过程中，我需要复习一些基础知识，有几方面的原因，其一，我虽是计算机科学与技术系毕业，但部分知识的细节忘记了，甚至已经还给了大学老师；其二，现在有很多来自数学系、物理系、自动化控制系的程序员，尽管他们能力很强，但由于时间关系，他们很难像计算机科学与技术系毕业的程序员一样系统地学过计算机理论，但凡事均有例外，完全掌握的直接跳过。
